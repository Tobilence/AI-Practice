...
class DogsVSCats():
    IMG_SIZE = 50
    CATS = "convnet-practice/KAGGLE/kagglecatsanddogs_3367a/PetImages/Cat"
    DOGS = "convnet-practice/KAGGLE/kagglecatsanddogs_3367a/PetImages/Dog"
...
if REBUILD_DATA:
    ...
    training_data = np.load("convnet-practice/training_data.npy", allow_pickle=True)
...
def train():
    BATCH_SIZE=100
    EPOCHS=1
    with open("convnet-practice/model.log", "a") as f:
